...
public class SetPermission extends ACommand {
    ...
    public SetPermission(GuildMessageReceivedEvent event, String[] args, ECommand command, PGuild guild, EPermission permission) {
        super(event, args, command, guild);
        this.permission = permission;
    }

    public SetPermission(GuildMessageReceivedEvent event, ECommand command, PGuild guild) {
    ...
    public void help(boolean embedState) {
        if (embedState) {
            ...
            sendHelpEmbed(
                    ...
                    + EPermission.USER.getName() + ": `" + getGuildPrefix() + ECommand.SETUSER.getName() + "`\n\n- "
                    + EPermission.MODERATOR.getName() + ": `" + getGuildPrefix() + ECommand.SETMODO.getName() + "`\n\n- "
                    + EPermission.ADMINISTRATOR.getName() + ": `" + getGuildPrefix() + ECommand.SETADMIN.getName() + "`\n\n"
                    + "Example: `" + getGuildPrefix() + ECommand.SETADMIN.getName() + " @aMember`.\n\n"
